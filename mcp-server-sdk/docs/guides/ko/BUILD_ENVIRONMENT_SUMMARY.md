...
- **BUILD_CHECK_KO.md** - 빌드 환경 상세 가이드
- **DEV_SETUP_KO.md** - 개발 환경 설정 가이드
- **QUICKSTART_KO.md** - 빠른 시작 가이드
- **ARCHITECTURE_KO.md** - 시스템 아키텍처
...
문제가 발생하면:
1. BUILD_CHECK_KO.md 참조
2. DEV_SETUP_KO.md 참조
3. QUICKSTART_KO.md 참조
